              ...
              <div className="container">
                  ...
                  <div className="split-about">
                    <motion.div initial={{x: '-100%', opacity: 0}} whileInView={horizontal} className="about-content">
                        <p>Hello! My name is Rubens and I enjoy creating things that live on the internet. My interest in web development started back in 2010 when I decided to try out for my first school project — turns out putting together a simple website taught me a lot about HTML & CSS! </p>
                        <br />
